...
import com.jnetai.phdresearch.BuildConfig
import com.jnetai.phdresearch.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareButton.setOnClickListener {
            startActivity(Intent.createChooser(Intent(Intent.ACTION_SEND).apply {
                type = "text/plain"; putExtra(Intent.EXTRA_TEXT, "Check out PhDResearch! https://github.com/jnetai-clawbot/PhDResearch")
            }, "Share"))
        }
    }
    private fun checkForUpdates() {
        ...
        Thread {
            try {
                val json = JSONObject(URL("https://api.github.com/repos/jnetai-clawbot/PhDResearch/releases/latest").readText())
